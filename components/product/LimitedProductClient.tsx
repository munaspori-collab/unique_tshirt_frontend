...
export default function LimitedProductClient({ slug }: { slug: string }) {
    ...
    return (
      <div className="min-h-screen bg-premium-base pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link href="/shop/limited" className="inline-flex items-center text-gray-700 hover:text-gray-900 mb-8">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex items-center text-yellow-600">
                  ...
                  <span className="ml-1 text-gray-600">(128 reviews)</span>
                </div>
              </div>
            </div>
